            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?= base_url() ?>/public/images/testimonials-2-men-talking.svg" alt="alternative">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?= base_url() ?>/public/images/testimonial-1.svg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?= base_url() ?>/public/images/testimonial-2.svg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?= base_url() ?>/public/images/testimonial-3.svg" alt="alternative">
                                        <div class="card-body">
