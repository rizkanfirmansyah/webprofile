                ...
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?= base_url() ?>/public/images/team-member-1.svg" alt="alternative">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?= base_url() ?>/public/images/team-member-2.svg" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?= base_url() ?>/public/images/team-member-3.svg" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?= base_url() ?>/public/images/team-member-4.svg" alt="alternative">
                        </div> <!-- end of image wrapper -->
